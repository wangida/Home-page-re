...
/* map2 는 A/B 시안 비교용 임시 슬라이드다 — 확정되면 map / map2 중 하나를 통째로 지운다.
   관련 코드는 모두 "[A/B 임시]" 주석으로 표시해 두었다. */
type SlideKey = "data" | "map2" | "map" | "ai" | "heat" | "robot" | "idol";
...
const HERO_SLIDES: Slide[] = [
  ...
  {
    /* [A/B 임시] 2번 슬라이드 — 지구본이 좌측에 반쯤 걸치는 원안(02 에셋).
       바로 뒤 map 슬라이드(원형 03)와 도트로 번갈아 보며 비교하기 위한 것이다. */
    key: "map2",
    eyebrow: "케이웨더 맵",
    title: "국내 정밀 예보부터\n글로벌 날씨까지\n한눈에 확인합니다",
  ...
  {
    /* 신설 슬라이드 — 배경(우주)과 지구본을 따로 얹어 지구본만 별도 연출 */
    key: "map",
    eyebrow: "케이웨더 맵",
    title: "국내 정밀 예보부터\n글로벌 날씨까지\n한눈에 확인합니다",
      ...
      {(s.key === "map" || s.key === "map2") && (
        ...
        >
          ...
          <img
            ...
            /* [A/B 임시] map2 만 02 에셋 — 확정되면 이 삼항을 지운다 */
            src={
              s.key === "map2"
                ? "/assets/hero_map_earth02.png"
                : "/assets/hero_map_earth03.png"
            }
