...
export const WEATHER_NAV_CASES: ReferenceCase[] = [
  ...
  { href: "/reference/weather/08", cat: "날씨경영", name: "경기주택도시공사", thumb: "/assets/sub/reference_wthumsmall04.jpg" },
  { href: "/reference/weather/09", cat: "날씨경영", name: "카카오", thumb: "/assets/sub/reference_wthumsmall01.jpg?v=5" },
  { href: "/reference/weather/10", cat: "날씨경영", name: "네이버", thumb: "/assets/sub/reference_wthumsmall02.jpg?v=4" },
  { href: "/reference/weather/11", cat: "날씨경영", name: "SK커뮤니케이션즈 - 네이트", thumb: "/assets/sub/reference_wthumsmall03.jpg?v=4" },
  { href: "/reference/weather/04", cat: "날씨경영", name: "날씨 달력", thumb: "/assets/sub/reference_wthumsmall05.jpg" },
  { href: "/reference/weather/05", cat: "날씨경영", name: "날씨판매지수", thumb: "/assets/sub/reference_wthumsmall06.jpg" },
  { href: "/reference/weather/06", cat: "날씨경영", name: "날씨수요예측", thumb: "/assets/sub/reference_wthumsmall07.jpg" },
  { href: "/reference/weather/07", cat: "날씨경영", name: "날씨영향분석", thumb: "/assets/sub/reference_wthumsmall08.jpg" },
];
