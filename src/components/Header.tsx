...
const MEGA_COLS: { key: string; x: number; blocks: MegaBlock[] }[] = [
  ...
  },
  {
    ...
    x: 762,
    blocks: [
      { y: 16, items: [{ label: "AI 환기청정" }, { label: "조리실 자동제어", href: "/solution/kitchen" }, { label: "공기질 통합관리", href: "/solution/airall" }, { label: "저온저장창고", href: "/solution/coldstorage" }, { label: "에어로봇", href: "/solution/airrobot" }] },
      { y: 324, tight: true, items: [{ label: "기후위험 관리", small: "(폭염·건설·해양·ESG)", href: "/solution/crmaas/heat" }] },
    ],
  },
  {
    key: "ref",
